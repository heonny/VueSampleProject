            ...
            <b-form-group id="file-input">
                <b-row>
                    ...
                    <b-col class="btnSm" cols="3">
                        <b-button variant="outline-primary" v-on:click="submitFile()">Submit!
                        </b-button>
                    </b-col>
                </b-row>
            </b-form-group>
                ...
                <b-list-group-item
                    ...
                    <b-row>
                        <b-col class="align-self-center" cols="6">
                            ...
                            <b-icon-card-image
                                v-else-if="fileItem.mimeType.includes('image')"></b-icon-card-image>
            ...
            vm.$http.post('/api/downFile/' + reqData, "", {responseType: "blob"}).then(
                res => {
                    ...
                    if (contentDisposition) {
                        const [fileNameMatch] = contentDisposition.split(';').filter(
                            str => str.includes('filename'))
                        if (fileNameMatch) {
